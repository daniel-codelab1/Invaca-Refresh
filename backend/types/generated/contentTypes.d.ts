...
export interface ApiBrandBrand extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::brand.brand'> &
      Schema.Attribute.Private;
    Malls: Schema.Attribute.Relation<'manyToMany', 'api::mall.mall'>;
    Name: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiGovernanceGovernance extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    Members: Schema.Attribute.Component<'layout.corporate-members', true>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiHistoryHistory extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    HistoryBlocks: Schema.Attribute.Component<'layout.history-blocks', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::history.history'
...
export interface ApiMallMall extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    CommercialArea: Schema.Attribute.String;
    Contact: Schema.Attribute.Component<'mall-details.contact', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::mall.mall'> &
      Schema.Attribute.Private;
    Location: Schema.Attribute.String;
    MainImage: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    Managers: Schema.Attribute.Component<'mall-details.manager', true>;
    MapEmbedUrl: Schema.Attribute.Text;
    Name: Schema.Attribute.String;
    Performance: Schema.Attribute.Component<'mall-details.performance', false>;
    publishedAt: Schema.Attribute.DateTime;
    SecondaryImage: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    Slug: Schema.Attribute.UID;
    Stats: Schema.Attribute.Component<'mall-details.stats', false>;
...
export interface ApiOldAssetOldAsset extends Struct.CollectionTypeSchema {
  collectionName: 'old_assets';
  info: {
    displayName: 'Old Asset';
    pluralName: 'old-assets';
    singularName: 'old-asset';
  };
  options: {
    draftAndPublish: true;
  };
