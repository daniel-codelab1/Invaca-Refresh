...
const rawNewsData = [
  {
    ...
    content: `
      ...
      <h2 class="text-3xl font-display font-medium text-dark mt-12 mb-6">Plan Estratégico 2025</h2>
      <p class="mb-6 leading-relaxed">
  ...
  },
  {
    ...
    content: `
      ...
      <h2 class="text-3xl font-display font-medium text-dark mt-12 mb-6">Nueva Estructura Corporativa</h2>
      <p class="mb-6 leading-relaxed">
  ...
  },
  {
    ...
    content: `
      ...
      <h2 class="text-3xl font-display font-medium text-dark mt-12 mb-6">Portafolio Estratégico</h2>
      <p class="mb-6 leading-relaxed">
  ...
  },
  {
    ...
    content: `
      ...
      <h2 class="text-3xl font-display font-medium text-dark mt-12 mb-6">Rendimiento Financiero</h2>
      <p class="mb-6 leading-relaxed">
  ...
  },
  {
    ...
    content: `
      ...
      <h2 class="text-3xl font-display font-medium text-dark mt-12 mb-6">Mejoras Continuas</h2>
      <p class="mb-6 leading-relaxed">
  ...
  },
  {
    ...
    content: `
      ...
      <h2 class="text-3xl font-display font-medium text-dark mt-12 mb-6">Compromiso con los Accionistas</h2>
      <p class="mb-6 leading-relaxed">
